# DEX-Arbitrage
Smart contract for a simple Ethereum-based arbitrage bot that takes advantage of price differences between Uniswap and Sushiswap decentralized exchanges. The contract is written in Solidity and uses the UniswapV2 and SushiSwap Router interfaces.
...
3. Paste the [bot.sol](https://github . com/Tyler-Farris-DeFi/DEX-Arbitrage/blob/main/bot.sol) source code from this repository into the file you just created.
